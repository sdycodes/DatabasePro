<?php
	...
	if($id==NULL){
      ...
      header("refresh:0.2;url=modify_author.php");
		}
	}
	else{
		...
		$gender = $_POST['gender'];
		$era = $_POST['era'];
		$sql = "update Author set name='$newName', gender= '$gender', era='$era' where id ='$id'";
    ...
    <div class="container">
      <div class="row">
          ...
          <div class="col-md-offset-2 col-md-8 col-sm-12">
              <h1 class="wow fadeInUp" data-wow-delay="1s">修改作者</h1>
              <form class="wow fadeInUp"  data-wow-delay="1s" action="./modify_author.php" method="POST">
      ...
      <div class="row">
          ...
          <div class="col-md-offset-2 col-md-8 col-sm-12">
			...
			<span class="input input-hoshi">
				...
				<h3 style='color:#fff;margin-top:0em'>输入新年代</h3>
				<input class="input_field input_field-hoshi" type="text" id="era" name="era" value="<?php echo $res['era'];?>" size="8">
			</span>
			
			<span class="input input-hoshi">
				<label class="input_label input_label-hoshi input_label-hoshi-color-1" for="input-4">
				</label>
				<h3 style='color:#fff;margin-top:0em'>输入新性别</h3>
				<input class="input_field input_field-hoshi" type="text" id="gender" name="gender" value="<?php echo $res['gender'];?>" size="8">
			</span>
			<br>
